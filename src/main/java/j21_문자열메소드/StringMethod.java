...
//		String subName1 = name.substring(name.indexOf("김수현"),name.indexOf("김수현") + name1.length());
//		String subName2 = name.substring(name.indexOf("김준일"),name.indexOf("김준일") + name2.length());
